<?php
/**
 * Создайте контроллер PageController с действием act. Добавьте представление для этого действия.
 * Передайте в представление переменные var1, var2, var3 и отобразите их.
